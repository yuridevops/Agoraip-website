        ...
        <header>
            ...
            <div className="container-contact">
                <ul className="page-links">
                    <Link to="/agoraip-website" onClick={() => selectLink(0)} ><li className={isSelected(0)} >Inicio</li></Link>
                    <Link to="/agoraip-website/planos" onClick={() => selectLink(1)} ><li className={isSelected(1)} >Planos</li></Link>
                    <Link to="/agoraip-website/sobre" onClick={() => selectLink(2)}><li className={isSelected(2)} >Sobre nós</li></Link>
